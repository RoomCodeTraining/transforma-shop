                                        ...
                                        @foreach ($cartItems as $items)
                                            <tr>
                                                <td class="pro-thumbnail"><a href="#"><img width="350"
                                                            height="350" src="{{ $item->model->image }}" class="img-fluid"
                                                            alt="Product"></a></td>
                                                <td class="pro-title"><a href="#">{{ $items->model->name }}</a>
                                                </td>
                                                <td class="pro-price"><span>{{ $items->price }} FCFA</span></td>
                                                <td class="pro-quantity">
                                                    <div class="pro-qty"><input type="text" value="{{ $items->qty }}">
                                                    </div>
                                                </td>
                            ...
                            <div class="col-lg-6 col-12 d-flex">
                                ...
                                <div class="cart-summary">
                                    <div class="cart-summary-wrap">
                                        ...
                                        <p>Sous-total <span>${{ Cart::instace('cart')->subtotal() }}</span></p>
                                        <p>Taxe<span>{{ Cart::instace('cart')->tax() }}</span></p>
                                        <p>Frais de livraison <span>$00.00</span></p>
                                        <h2>Total <span>${{ Cart::instace('cart')->total() }}</span></h2>
                                    </div>
