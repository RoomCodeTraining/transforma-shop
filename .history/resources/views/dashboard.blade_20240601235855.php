                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-12 mb-30">
                                                        <input id="phone" placeholder="Contact"
                                                            value="{{ $profile->phone }}" type="number">
                                                    </div>

                                                    <div class="col-12 mb-30">
                                                        <input id="display-name" value="{{ $value->email }}"
                                                            placeholder="email" type="email">
                                                    </div>

                                                    <div class="col-12 mb-30">
                                                        <input id="contact" placeholder="Téléphone"
                                                            value="{{ $value->phone }}" type="number">
                                                    </div>
