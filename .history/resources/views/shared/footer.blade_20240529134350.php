							...
							<div class="contact-segments d-flex justify-content-between flex-wrap flex-lg-nowrap">
								...
								<div class="single-contact d-flex mb-xs-20">
									...
									<div class="contact-info">
										<p>Adresse: <span>Abidjan, Cote d'ivoire</span></p>
									</div>
								</div>
								...
								<div class="single-contact d-flex mb-xs-20">
									...
									<div class="contact-info">
										<p>Contact: <span>1-888-123-456-89</span></p>
									</div>
								</div>
								...
								<div class="single-contact d-flex">
									...
									<div class="contact-info">
										<p>Email: <span>info@transforma.ci</span></p>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center text-md-start">
						<div class="copyright-segment">
							<p>
								...
								<a href="#">Terms et conditions d'utilisation</a>
							</p>
							<p class="copyright-text">&copy; 2024 <a href="#">Transforma</a>. Tous droits reservés</p>
						</div>
									...
									<div class="nav small-image-slider" role="tablist">
										<div class="single-small-image img-full">
											<a data-bs-toggle="tab" id="single-slide-tab-1" href="#single-slide1"><img
													width="350" height="350" src="assets/images/products/product01.webp" class="img-fluid" alt=""></a>
										</div>
										<div class="single-small-image img-full">
											<a data-bs-toggle="tab" id="single-slide-tab-2" href="#single-slide2"><img
													width="350" height="350" src="assets/images/products/product02.webp" class="img-fluid" alt=""></a>
										</div>
										<div class="single-small-image img-full">
											<a data-bs-toggle="tab" id="single-slide-tab-3" href="#single-slide3"><img
													width="350" height="350" src="assets/images/products/product03.webp" class="img-fluid" alt=""></a>
										</div>
										<div class="single-small-image img-full">
											<a data-bs-toggle="tab" id="single-slide-tab-4" href="#single-slide4"><img
													width="350" height="350" src="assets/images/products/product04.webp"
