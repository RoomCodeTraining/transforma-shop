                                    ...
                                    <li>
                                        ...
                                        <form method="POST" action="{{ route('logout') }}">
                                            ...
                                            <button type="submit" role="menuitem"
                                                class="w-full text-left flex items-center space-x-2  rounded py-2 px-3 text-sm font-medium text-green-600 hover:bg-primary-900 hover:text-gray-50 focus:outline-none focus:bg-gray-100 focus:text-gray-700">
