...
<!-- Mirrored from themes.pixelstrap.com/fastkart/front-end/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Feb 2024 20:41:09 GMT -->
<head>
    ...
    <!-- bootstrap css -->
    <link id="rtl-link" rel="stylesheet" type="text/css" href="https://themes.pixelstrap.com/fastkart/assets/css/vendors/bootstrap.css">
                            ...
                            <li class="right-nav-list">
                                <div class="dropdown theme-form-select">
                                    <button class="btn dropdown-toggle" type="button" id="select-language"
                                        ...
                                        <img src="https://themes.pixelstrap.com/fastkart/assets/images/country/united-states.png"
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <a class="dropdown-item" href="javascript:void(0)" id="english">
                                                <img src="https://themes.pixelstrap.com/fastkart/assets/images/country/united-kingdom.png"
                                                    class="img-fluid blur-up lazyload" alt="">
                                                <span>English</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="javascript:void(0)" id="france">
                                                <img src="https://themes.pixelstrap.com/fastkart/assets/images/country/germany.png"
                                                    class="img-fluid blur-up lazyload" alt="">
                                                <span>Germany</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="javascript:void(0)" id="chinese">
                                                <img src="https://themes.pixelstrap.com/fastkart/assets/images/country/turkish.png"
                                                    class="img-fluid blur-up lazyload" alt="">
                                                <span>Turki</span>
                                            </a>
                                        </li>
                    ...
                    <div class="col-12">
                        <div class="navbar-top">
                            ...
                            <a href="index.html" class="web-logo nav-logo">
                                <img src="https://themes.pixelstrap.com/fastkart/assets/images/logo/1.png" class="img-fluid blur-up lazyload" alt="">
                            </a>
                                                            ...
                                                            <div class="dropdown-column m-0">
                                                                <div class="menu-img-banner">
                                                                    <a class="text-title" href="product-circle.html">
                                                                        <img src="https://themes.pixelstrap.com/fastkart/assets/images/mega-menu.png"
                                                                            alt="banner">
                                                                    </a>
                                                                </div>
                                                            </div>
            ...
            <div class="row g-4">
                <div class="col-xl-8 ratio_65">
                    <div class="home-contain h-100">
                        <div class="h-100">
                            <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/banner/1.jpg" class="bg-img blur-up lazyload" alt="">
                        </div>
                    ...
                    <div class="row g-4">
                        <div class="col-xl-12 col-md-6">
                            <div class="home-contain">
                                <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/banner/2.jpg" class="bg-img blur-up lazyload"
                                    alt="">
                        ...
                        <div class="col-xl-12 col-md-6">
                            <div class="home-contain">
                                <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/banner/3.jpg" class="bg-img blur-up lazyload"
                                    alt="">
                                <div class="home-detail p-center-left home-p-sm w-75">
                                    <div>
            ...
            <div class="banner-slider">
                <div>
                    <div class="banner-contain hover-effect">
                        <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/banner/4.jpg" class="bg-img blur-up lazyload" alt="">
                ...
                <div>
                    <div class="banner-contain hover-effect">
                        <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/banner/5.jpg" class="bg-img blur-up lazyload" alt="">
                        <div class="banner-details">
                            <div class="banner-box">
                                <h6 class="text-danger">5% OFF</h6>
                ...
                <div>
                    <div class="banner-contain hover-effect">
                        <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/banner/6.jpg" class="bg-img blur-up lazyload" alt="">
                        <div class="banner-details">
                            <div class="banner-box">
                                <h6 class="text-danger">5% OFF</h6>
                ...
                <div>
                    <div class="banner-contain hover-effect">
                        <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/banner/7.jpg" class="bg-img blur-up lazyload" alt="">
                        <div class="banner-details">
                            <div class="banner-box">
                                <h6 class="text-danger">5% OFF</h6>
                                <h5>Buy More & Save More</h5>
                    ...
                    <div class="p-sticky">
                        ...
                        <div class="ratio_156 section-t-space">
                            <div class="home-contain hover-effect">
                                <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/banner/8.jpg" class="bg-img blur-up lazyload"
                                    alt="">
                        ...
                        <div class="ratio_medium section-t-space">
                            <div class="home-contain hover-effect">
                                <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/banner/11.jpg" class="img-fluid blur-up lazyload"
                                    alt="">
                                <div class="home-detail p-top-left home-p-medium">
                                    <div>
                            ...
                            <div class="category-menu">
                                ...
                                <ul class="product-list border-0 p-0 d-block">
                                    <li>
                                        <div class="offer-product">
                                            <a href="product-left-thumbnail.html" class="offer-image">
                                                <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/product/23.png"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                    ...
                                    <li>
                                        <div class="offer-product">
                                            <a href="product-left-thumbnail.html" class="offer-image">
                                                <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/product/24.png"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                    ...
                                    <li>
                                        <div class="offer-product">
                                            <a href="product-left-thumbnail.html" class="offer-image">
                                                <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/product/25.png"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                    ...
                                    <li class="mb-0">
                                        <div class="offer-product">
                                            <a href="product-left-thumbnail.html" class="offer-image">
                                                <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/product/26.png"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                ...
                                <div class="review-box">
                                    ...
                                    <div class="review-profile">
                                        <div class="review-image">
                                            <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/review/1.jpg"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </div>
                ...
                <div class="col-xxl-9 col-xl-8">
                                    ...
                                    <div class="row m-0">
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                ...
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/product/7.png"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top"
                                        ...
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/product/8.png"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <div class="row m-0">
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/product/9.png"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top"
                    ...
                    <div class="section-t-space section-b-space">
                        <div class="row g-md-4 g-3">
                            <div class="col-md-6">
                                <div class="banner-contain hover-effect">
                                    <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/banner/9.jpg" class="bg-img blur-up lazyload"
                                        alt="">
                            ...
                            <div class="col-md-6">
                                <div class="banner-contain hover-effect">
                                    <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/banner/10.jpg" class="bg-img blur-up lazyload"
                                        alt="">
                                    <div class="banner-details p-center-left p-4">
                                        <div>
                                            <h3 class="text-exo">50% offer</h3>
                    ...
                    <div class="section-t-space">
                        <div class="banner-contain">
                            <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/banner/15.jpg" class="bg-img blur-up lazyload" alt="">
                    ...
                    <div class="section-t-space section-b-space">
                        <div class="row g-md-4 g-3">
                            <div class="col-xxl-8 col-xl-12 col-md-7">
                                <div class="banner-contain hover-effect">
                                    <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/banner/12.jpg" class="bg-img blur-up lazyload"
                                        alt="">
                                    <div class="banner-details p-center-left p-4">
                                        <div>
                            ...
                            <div class="col-xxl-4 col-xl-12 col-md-5">
                                <a href="shop-left-sidebar.html" class="banner-contain hover-effect h-100">
                                    <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/banner/13.jpg" class="bg-img blur-up lazyload"
                                        alt="">
                        ...
                        <div>
                            <ul class="product-list">
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/product/14.png"
                                                class="blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <ul class="product-list">
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/product/15.png"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/product/16.png"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/product/17.png"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/product/18.png"
                                                class="blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <ul class="product-list">
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/product/19.png"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/product/22.png"
                                                class="blur-up lazyload" alt="">
                                        </a>
                    ...
                    <div class="section-t-space">
                        <div class="banner-contain hover-effect">
                            <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/banner/14.jpg" class="bg-img blur-up lazyload" alt="">
                    ...
                    <div class="slider-3-blog ratio_65 no-arrow product-wrapper">
                            ...
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <a href="blog-detail.html" class="blog-image">
                                        <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/blog/1.jpg" class="bg-img blur-up lazyload"
                                            alt="">
                                    </a>
                                </div>
                        ...
                        <div>
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <a href="blog-detail.html" class="blog-image">
                                        <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/blog/2.jpg" class="bg-img blur-up lazyload"
                                            alt="">
                                    </a>
                                </div>
                        ...
                        <div>
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <a href="blog-detail.html" class="blog-image">
                                        <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/blog/3.jpg" class="bg-img blur-up lazyload"
                                            alt="">
                                    </a>
                                </div>
    ...
    <footer class="section-t-space">
        <div class="container-fluid-lg">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="footer-logo">
                            <div class="theme-logo">
                                <a href="index.html">
                                    <img src="https://themes.pixelstrap.com/fastkart/assets/images/logo/1.png" class="blur-up lazyload" alt="">
                                </a>
                            </div>
            ...
            <div class="sub-footer section-small-space">
                ...
                <div class="payment">
                    <img src="https://themes.pixelstrap.com/fastkart/assets/images/payment/1.png" class="blur-up lazyload" alt="">
                </div>
                    ...
                    <div class="row g-sm-4 g-2">
                        <div class="col-lg-6">
                            <div class="slider-image">
                                <img src="https://themes.pixelstrap.com/fastkart/assets/images/product/category/1.jpg" class="img-fluid blur-up lazyload"
                                    alt="">
                            </div>
                        </div>
    ...
    <div class="cookie-bar-box">
        <div class="cookie-box">
            <div class="cookie-image">
                <img src="https://themes.pixelstrap.com/fastkart/assets/images/cookie-bar.png" class="blur-up lazyload" alt="">
                <h2>Cookies!</h2>
            </div>
                    ...
                    <div class="deal-offer-box">
                        <ul class="deal-offer-list">
                            <li class="list-1">
                                <div class="deal-offer-contain">
                                    <a href="shop-left-sidebar.html" class="deal-image">
                                        <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/product/10.png" class="blur-up lazyload"
                                            alt="">
                                    </a>
                            ...
                            <li class="list-2">
                                <div class="deal-offer-contain">
                                    <a href="shop-left-sidebar.html" class="deal-image">
                                        <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/product/11.png" class="blur-up lazyload"
                                            alt="">
                                    </a>
                            ...
                            <li class="list-3">
                                <div class="deal-offer-contain">
                                    <a href="shop-left-sidebar.html" class="deal-image">
                                        <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/product/12.png" class="blur-up lazyload"
                                            alt="">
                                    </a>
                            ...
                            <li class="list-1">
                                <div class="deal-offer-contain">
                                    <a href="shop-left-sidebar.html" class="deal-image">
                                        <img src="https://themes.pixelstrap.com/fastkart/assets/images/vegetable/product/13.png" class="blur-up lazyload"
                                            alt="">
                                    </a>
